...
COPY public.cliente (nombre, dni, apellidos, usuario, contrasena, email, telefono, direccion, numcredito) FROM stdin;
María	987654321	López	marialo	maria123	maria@email.com	987654321	Avenida 456	123456789
Pedro	555555555	Gómez	pedrog	pedro456	pedro@email.com	555555555	Carrera 789	111111111
Ana	111111111	Martínez	anam	ana789	ana@email.com	111111111	Callejon 567	222222222
Carlos	222222222	Sánchez	carloss	carlos123	carlos@email.com	222222222	Plaza 890	333333333
Juan	123456789	Pérez	juanito	contraseña123	juan@email.com	484848484	Calle 123	987654321
\.
...
COPY public.habitacion (id_hab, cap_adultos, cap_ninos, estado, tipo, preciobase) FROM stdin;
2	1	0	Ocupada	Individual	300
1	2	1	Disponible	Doble	400
4	2	0	Disponible	Doble	400
3	4	2	Disponible	Familiar	500
5	3	1	Fuera de servicio	Suite	600
\.
...
COPY public.reserva (num_reserva, num_habitacion, dni_cliente, num_adultos, num_ninos, acomodacion, fecha_fin, fecha_inicio) FROM stdin;
1	1	123456789	2	1	Estandar	2024-02-01	2024-02-05
2	3	987654321	3	2	VIP	2024-03-10	2024-03-15
3	2	555555555	1	0	Estandar	2024-04-20	2024-04-22
4	4	111111111	2	1	Especial	2024-05-05	2024-05-10
5	5	222222222	2	0	Estandar	2024-06-15	2024-06-20
\.
...
COPY public.suplementos (nombre, valor) FROM stdin;
Desayuno	10
WiFi	5
Estacionamiento	15
Spa	20

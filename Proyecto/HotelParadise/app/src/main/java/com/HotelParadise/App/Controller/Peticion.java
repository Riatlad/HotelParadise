...
package com.HotelParadise.App.Controller;
...
public class Peticion {
    ...
    private static final String URL = "“localhost:7777/HotelServlet/HotelServidor?peticion=private String cp";
    ...
    public void requestData(String variable) { //Aqui es donde se le manda clientes o habitaciones
